...
import com.paxar.qps.common.web.AbstractController;

/**
 * Throws when it was failed to setup request handler factory in some Controller (see
 * {@link AbstractController#setupRequestHandlerFactory(RequestHandlerByActionFactory)}).
 *
 * @author rsav
 * @version 1.0
 */
